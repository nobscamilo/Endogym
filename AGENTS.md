...
- `main` local está alineado con `origin/main` en `a7b7482` antes del working tree del 20 jun 2026. Ese working tree fue desplegado manualmente a `dpl_FpbL91Ukd97dy9aT73iAwX8rh52h`, pero sigue sin commit/push: **producción no es reproducible desde `origin/main`**. Quedan artefactos/logs posibles en `scratch/`, `.playwright-cli/` y `output/`; ignóralos salvo que el usuario pida limpieza.
