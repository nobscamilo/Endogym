...
Auditoría de solo lectura a petición del usuario ("busca código hardcodeado, todo tiene que ser real, sé meticuloso"). **No se modificó código**; solo este registro. Estado git: `main` = `origin/main` en `a7b7482`, pero el working tree del 20 jun (≈34 archivos: bundle, todas las rutas API, `planner.js`, `exerciseLibrary.js`, docs) **sigue sin commitear** → producción (`dpl_FpbL91Ukd97dy9aT73iAwX8rh52h`) no es reproducible desde git. Es el riesgo abierto #1.
