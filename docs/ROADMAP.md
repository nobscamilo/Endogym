...
- [ ] **`weekly-plan` cae al heurístico demasiado.** El aviso nuevo lo destapa: 56% de fallback en julio (9 de 16 llamadas), incluidos los días 21 y 22, ya después del fix de timeout del 20 jul. Hay que mirar los logs de `GEMINI_COACH_*` para ver si es timeout, esquema o cuota.
